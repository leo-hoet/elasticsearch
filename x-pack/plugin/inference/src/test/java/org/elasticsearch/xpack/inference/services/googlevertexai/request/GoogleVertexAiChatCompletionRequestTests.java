...
public class GoogleVertexAiChatCompletionRequestTests extends ESTestCase {

    private static final String AUTH_HEADER_VALUE = "Bearer foo";

    // TODO: add more test here to check the generation configuration, different role models, etc
